...
var _vestPocket = require("@mycolorway/vest-pocket");
...
Component({
  ...
  methods: {
    ...
    scrollToInput: function scrollToInput(input) {
      ...
      _vestPocket.wx.createSelectorQuery().in(input).select('.weui-cell, .form-input').boundingClientRect(function (rect) {
        _vestPocket.wx.createSelectorQuery().selectViewport().scrollOffset(function (result) {
          _vestPocket.wx.pageScrollTo({
